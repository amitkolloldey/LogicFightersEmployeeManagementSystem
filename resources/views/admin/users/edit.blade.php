        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($user->employee_image)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$user->employee_image) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$user->employee_image) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @if ($user->cv)
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $user->cv) }}" target="_blank">Download file</a>
                    @endif
