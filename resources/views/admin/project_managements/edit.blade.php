...
@section('content')
    ...
    {!! Form::model($project_management, ['method' => 'PUT', 'route' => ['admin.project_managements.update', $project_management->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('document', trans('lfems.project-management.fields.document').'', ['class' => 'control-label']) !!}
                    {!! Form::file('document[]', [
                        'multiple',
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($project_management->getMedia('document') as $media)
                                <p class="form-group">
